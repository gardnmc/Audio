...
Java_com_example_audio_AudioRecordActivity_createEngine(JNIEnv *env, jclass clazz) {
    SLresult result;
...
Java_com_example_audio_AudioRecordActivity_createBufferQueueAudioPlayer(JNIEnv *env, jclass clazz,
                                                                        jint sample_rate,
    ...
    if (sample_rate >= 0 && samples_per_buf >= 0 ) {
         ...
         */
        bqPlayerBufSize = samples_per_buf;
    }
...
Java_com_example_audio_AudioRecordActivity_createAssetAudioPlayer(JNIEnv *env, jclass clazz,
...
Java_com_example_audio_AudioRecordActivity_setPlayingAssetAudioPlayer(JNIEnv *env, jclass clazz,
                                                                      jboolean is_playing) {
    SLresult result;
...
Java_com_example_audio_AudioRecordActivity_createUriAudioPlayer(JNIEnv *env, jclass clazz,
                                                                jstring uri) {
    SLresult result;
...
Java_com_example_audio_AudioRecordActivity_setPlayingUriAudioPlayer(JNIEnv *env, jclass clazz,
                                                                    jboolean is_playing) {
    SLresult result;
    ...
    if (NULL != uriPlayerPlay) {
        ...
        // set the player's state
        result = (*uriPlayerPlay)->SetPlayState(uriPlayerPlay, is_playing ?
                                                               SL_PLAYSTATE_PLAYING : SL_PLAYSTATE_PAUSED);
        assert(SL_RESULT_SUCCESS == result);
        (void)result;
    }
...
Java_com_example_audio_AudioRecordActivity_setLoopingUriAudioPlayer(JNIEnv *env, jclass clazz,
                                                                    jboolean is_looping) {
    SLresult result;
    ...
    if (NULL != uriPlayerSeek) {
        ...
        result = (*uriPlayerSeek)->SetLoop(uriPlayerSeek, (SLboolean) is_looping, 0,
                                           SL_TIME_UNKNOWN);
        assert(SL_RESULT_SUCCESS == result);
        (void)result;
    }
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_audio_AudioRecordActivity_setChannelMuteUriAudioPlayer(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_audio_AudioRecordActivity_setChannelSoloUriAudioPlayer(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_audio_AudioRecordActivity_getNumChannelsUriAudioPlayer(JNIEnv *env, jclass clazz) {
    SLuint8 numChannels;
    SLresult result;
    SLMuteSoloItf muteSoloItf = getMuteSolo();
    if (NULL != muteSoloItf) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_audio_AudioRecordActivity_setVolumeUriAudioPlayer(JNIEnv *env, jclass clazz,
                                                                   jint millibel) {
    SLresult result;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_audio_AudioRecordActivity_setMuteUriAudioPlayer(JNIEnv *env, jclass clazz,
                                                                 jboolean mute) {
    SLresult result;
    SLVolumeItf volumeItf = getVolume();
    if (NULL != volumeItf) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_audio_AudioRecordActivity_enableStereoPositionUriAudioPlayer(JNIEnv *env,
                                                                              jclass clazz,
                                                                              jboolean enable) {
    SLresult result;
    SLVolumeItf volumeItf = getVolume();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_audio_AudioRecordActivity_setStereoPositionUriAudioPlayer(JNIEnv *env,
                                                                           jclass clazz,
                                                                           jint permille) {
    SLresult result;
    SLVolumeItf volumeItf = getVolume();
...
Java_com_example_audio_AudioRecordActivity_selectClip(JNIEnv *env, jclass clazz, jint which,
                                                      jint count) {
...
Java_com_example_audio_AudioRecordActivity_enableReverb(JNIEnv *env, jclass clazz,
                                                        jboolean enabled) {
    SLresult result;
...
Java_com_example_audio_AudioRecordActivity_createAudioRecorder(JNIEnv *env, jclass clazz) {
    SLresult result;
...
Java_com_example_audio_AudioRecordActivity_startRecording(JNIEnv *env, jclass clazz) {
    SLresult result;
...
Java_com_example_audio_AudioRecordActivity_shutdown(JNIEnv *env, jclass clazz) {
